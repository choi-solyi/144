...
<style>
   ...
   #top_wrap a{
	...
	font-family:Arial;
	background:#808080;
	background:-o-linear-gradient(90deg, #808080, #d1d1d1);
	background:-moz-linear-gradient( center top, #808080 5%, #d1d1d1 100% );
	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #808080), color-stop(1, #d1d1d1) );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#808080', endColorstr='#d1d1d1');
	background:-webkit-linear-gradient(#808080, #d1d1d1);
	background:-ms-linear-gradient(#808080, #d1d1d1);
	background:linear-gradient(#808080, #d1d1d1);
	text-indent:0px;
	line-height:25px;
...
.top_board_btn:hover {
	background:#d1d1d1;
	background:-o-linear-gradient(90deg, #d1d1d1, #808080);
	background:-moz-linear-gradient( center top, #d1d1d1 5%, #808080 100% );
	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #d1d1d1), color-stop(1, #808080) );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#d1d1d1', endColorstr='#808080');
	background:-webkit-linear-gradient(#d1d1d1, #808080);
	background:-ms-linear-gradient(#d1d1d1, #808080);
	background:linear-gradient(#d1d1d1, #808080);
}
...
.top_board_no:hover {
	...
	font-family:Arial;
	background:#919191;
	background:-o-linear-gradient(90deg, #919191, #c2c2c2);
	background:-moz-linear-gradient( center top, #919191 5%, #c2c2c2 100% );
	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #919191), color-stop(1, #c2c2c2) );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#919191', endColorstr='#c2c2c2');
	background:-webkit-linear-gradient(#919191, #c2c2c2);
	background:-ms-linear-gradient(#919191, #c2c2c2);
	background:linear-gradient(#919191, #c2c2c2);
	text-indent:0px;
	line-height:10px;
...
.top_board_search_btn:hover{
	background:#c2c2c2;
	background:-o-linear-gradient(90deg, #c2c2c2, #919191);
	background:-moz-linear-gradient( center top, #c2c2c2 5%, #919191 100% );
	background:-webkit-gradient( linear, left top, left bottom, color-stop(0.05, #c2c2c2), color-stop(1, #919191) );
	filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#c2c2c2', endColorstr='#919191');
	background:-webkit-linear-gradient(#c2c2c2, #919191);
	background:-ms-linear-gradient(#c2c2c2, #919191);
	background:linear-gradient(#c2c2c2, #919191);
}
           ...
           <div class = "top_champ_inpo top_board_champ1">
              ...
              <div class = "top_board_champskill">
               ...
               <div class = "top_champ top_champ1_stt top_champ1_st1">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">재사용 대기시간: 9/8/7/6/5초</p>
               ...
               <div class = "top_champ top_champ1_stt top_champ1_st2">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">체력 소모: 현재의 20%, 재사용 대기시간: 28/25/22/19/16초</p>
                ...
                <div class = "top_champ top_champ1_stt top_champ1_st3">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">체력 소모: 최대 체력의 2~8%,
                    재사용 대기시간: 13/11/9/7/5초</p>
                   <p style="color: antiquewhite; font-size: 14px;">첫 번째 사용시: 블라디미르가 정신 집중을 하며 최대 체력의 8%까지 희생해 피의 웅덩이를 채웁니다. 선혈의 파도의 피해량도 같은 양만큼 늘어납니다. 웅덩이가 가득차면 블라디미르의 이동 속도가 느려집니다.<br>
               ...
               <div class = "top_champ top_champ1_stt top_champ1_st4">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">재사용 대기시간: 150/135/120초</p>
           ...
           <div class = "top_champ_inpo top_board_champ2">
              ...
              <div class = "top_board_champskill">
               ...
               <div class = "top_champ top_champ2_stt top_champ2_st1">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 20,
               ...
               <div class = "top_champ top_champ2_stt top_champ2_st2">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 80,
                ...
                <div class = "top_champ top_champ2_stt top_champ2_st3">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 70/85/100/115/130, 
                    재사용 대기시간: 12초</p>
               ...
               <div class = "top_champ top_champ2_stt top_champ2_st4">
                   ...
                   <p style="color: white; font-size: 14px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 100,
                    재사용 대기시간: 120초</p>
           ...
           <div class = "top_champ_inpo top_board_champ3">
              ...
              <div class = "top_board_champskill">
               ...
               <div class = "top_champ top_champ3_stt top_champ3_st1">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">분노 소모: 0 (50),
                    재사용 대기시간: 8초</p>
               ...
               <div class = "top_champ top_champ3_stt top_champ3_st2">
                ...
                <div class = "top_champ top_champ3_stt top_champ3_st3">
                   ...
                   <p style="color: antiquewhite; font-size: 14px;">자르기: 레넥톤이 돌격하여 40/70/100/130/160 (+0.9 추가AD)의 물리 피해를 입힙니다. 적을 맞히면 4초 이내에 토막내기를 쓸 수 있습니다.<br>
               ...
               <div class = "top_champ top_champ3_stt top_champ3_st4">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">재사용 대기시간: 120초</p>
           ...
           <div class = "top_champ_inpo top_board_champ4">
              ...
              <div class = "top_board_champskill">
               ...
               <div class = "top_champ top_champ4_stt top_champ4_st2">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 70/75/80/85/90,
                ...
                <div class = "top_champ top_champ4_stt top_champ4_st3">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 50/55/60/65/70,
                    재사용 대기시간: 18/16.5/15/13.5/12초</p>
                   <p style="color: antiquewhite; font-size: 14px;">이렐리아가 칼날 2개를 던집니다. 두 번째 칼날이 목표 위치에 도착한 뒤 두 칼날이 서로를 향해 날아가며, 이때 칼날에 적중한 적은 70/110/150/190/230 (+0.8AP) 의 마법 피해를 입고 0.75초 동안 기절합니다.<br>
               ...
               <div class = "top_champ top_champ4_stt top_champ4_st4">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 100,
              ...
              <div class = "top_board_champskill">
               ...
               <div class = "top_champ5_st top_champ5_st">
                  <div class = "top_champ top_champ5_stt top_champ5_stp">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">재사용 대기시간: 30/25/20초</p>
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3"></p>
               ...
               <div class = "top_champ top_champ5_stt top_champ5_st1">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 50,
               ...
               <div class = "top_champ top_champ5_stt top_champ5_st2">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 60,
                    재사용 대기시간: 13/12/11/10/9초</p>
                ...
                <div class = "top_champ top_champ5_stt top_champ5_st3">
                   ...
                   <p style="color: white; font-size: 12px; display: inline-block; float: right; line-height: 2.3; margin-bottom: -10px;">마나 소모: 60/65/70/75/80
                    재사용 대기시간: 10초</p>
                   <p style="color: antiquewhite; font-size: 14px;">마오카이가 30초 동안 주변을 감시하는 묘목을 던집니다. 묘목은 근처 적을 추격해 가까이 가면 폭발하며 25/50/75/100/125 + 대상의 최대 체력의 7/7.25/7.5/7.75/8% (+주문력 100당 1%)에 해당하는 마법 피해를 입힙니다. 폭발에 맞은 적은 2초 동안 35% 둔화됩니다.<br>
		...
		<div class = "top_board_paging">
			<div class = "top_board_paging_no">
                ...
                <c:forEach var = "i" begin = "${startblock}" end = "${endblock }" step = "1">
					...
					<c:if test="${currpage!=i }">
						<a class = "top_board_no" href = "toplist.do?curr=${i}&search=${search}&searchtxt=${searchtxt}">${i}</a>
					</c:if>
